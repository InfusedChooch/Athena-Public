...
- Links to: [Protocol 130: Vibe Coding](Athena-Public/examples/protocols/workflow/130-vibe-coding.md) — when speed matters
- Links to: Protocol 93: Forward-Only Architecture — freeze after validation (internal protocol)
- Links to: [TASK_LOG Template](Athena-Public/examples/templates/TASK_LOG_template.md) — intent persistence
