...
5. **Ignore** unrecognized files from other agents — focus on your changes only
...
- If commit/push already requested, auto-stage and include formatting follow-ups in the same commit — no extra confirmation
