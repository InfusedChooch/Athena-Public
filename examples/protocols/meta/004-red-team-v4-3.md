...
| Recommendation | Impact (1-10) | Ease (1-10) | Risk (L/M/H) | Entropy (1.0/0.8/0.5) | Final Score |
| :--- | :--- | :--- | :--- | :--- | :--- |
| Option A | 8 | 5 | Low (1.0) | Stable (1.0) | **13.0** |
| Option B | 9 | 4 | Med (1.5) | Decay (0.8) | **6.9** |
| Option C | 7 | 8 | High (2.0) | Rot (0.5) | **3.7** |
