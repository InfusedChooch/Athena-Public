...
> **Compiled**: 2026-05-11 (retroactive synthesis of all safety/health/finance sessions)
> **Problem Class**: All survival-level concerns — health, financial runway, legal exposure, psychological burnout, and the circuit breakers that prevent cascading collapse.
> **Axiom**: *"Survivors don't survive because they're better. They survive because they're structurally insulated from the forces that kill everyone else."*
...
**The 95-5 Arbitrage Rule** (STR-320):
If runway < 3 months: 95% effort → immediate revenue. 5% → long-term building. The bridge (contract work, gig work) is capped at 90 days MAX.
