...
|:-|:---------|:-------------------|
| 📓 | **Journaling & Brain-Dump** | **The #1 Daily Front Door.** Unstructured thought streams, daily reflection, and automated thread classification. Dump raw thoughts, vent, or process your day — Athena mirrors your thinking, extracts actionable decision/problem threads, and routes them to the right engine without jumping to premature advice. | <!-- pds:allow -->
| 🧠 | **Problem Solving** | *"I can't afford $200/hr therapy but I need to understand why I keep self-sabotaging."* — Diagnostic-first reasoning. Athena runs Gate 0 problem authentication, Graph of Thoughts (GoT) decomposition, and first-principles deconstruction to solve the *root cause*, not just the symptom. — [case study →](docs/CASE_STUDIES.md#case-study-2-the-200hr-therapist-alternative) | <!-- pds:allow -->
| 🎯 | **Decision Making** | *"Should I take this job? Sign this contract? Make this bet?"* — High-stakes decision analysis using the Collison Matrix (Magnitude × Reversibility), 70% Rule, Law #1 (No Irreversible Ruin), and personalized Economic Expected Value (EEV). — [case study →](docs/CASE_STUDIES.md#case-study-3-the-multi-stakeholder-career-decision) | <!-- pds:allow -->
| 🏠 | **Life Management** | The superset. Health, career, relationships, finances, client work — all managed as projects in one unified switchboard. By day 3, Athena remembers your schedule. By month 3, it anticipates your patterns. Athena doesn't have a separate project manager and life tracker — it has one board where your gym routine and your client deadline are rows governed by the same triage rules. — [case study →](docs/CASE_STUDIES.md#case-study-1-from-routine-app-to-life-engine-in-72-hours) | <!-- pds:allow -->
| 💼 | **Work & Projects** | Juggle 5+ projects without dropping context. `/project` gives you a visual switchboard — phase-gated progress, urgency/EV ranking, and instant context-switching. — [workflow →](examples/workflows/project.md) |
...
> 📖 **Deep Dive**: [How Athena Solves — The Three Core Use Cases](docs/USE_CASES.md) — covers Journaling/Brain-Dump capture, the vulnerability prerequisite, pre-work convergence, domain reclassification, the EEV decision framework, privacy architecture, and honest limitations.
