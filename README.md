...
| 📋 **118+ Protocols** | Ready-made decision frameworks (risk analysis, research, strategy, problem-solving) across 15 categories — [browse](examples/protocols/) |
...
| **SDK** | `athena` Python package (v9.4.1) |
