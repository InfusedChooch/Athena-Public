...
[![Version](https://img.shields.io/badge/v9.4.8-10b981?style=for-the-badge&label=Version)](docs/CHANGELOG.md)
...
| 📋 **140+ Protocols** | Ready-made decision frameworks (risk analysis, research, strategy, problem-solving) across 15 categories — [browse](examples/protocols/) |
...
├── examples/
│   ├── protocols/           # 140+ starter frameworks (15 categories)
