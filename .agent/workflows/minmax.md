...
- [/start](file:///../workflows/start.md) — Standard boot (modified by Minmax Rule 1)
- [/ultrastart](file:///../workflows/ultrastart.md) — Deep boot (most savings from Minmax Rule 1)
- [/end](file:///../workflows/end.md) — Standard close (modified by Minmax Rule 4)
- [Maximum Compute Doctrine](file:///../.context/CANONICAL.md) — §216 (the inverse of this workflow)
- [Context Density](file:///../.context/CANONICAL.md) — §194 (Dense Signal > Padded Context)
