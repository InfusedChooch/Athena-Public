...
- Psychology_L1L5.md (Current State)  # pds:allow
...
LIVING_DOCS = {
    ...
    "Psychology_L1L5.md": "Emotional shifts, schema updates, therapeutic insights",  # pds:allow
...
def main():
    ...
    if updates_needed or drift["recommendations"]:
        ...
        print("   • New psychological insights → Psychology_L1L5.md")  # pds:allow
